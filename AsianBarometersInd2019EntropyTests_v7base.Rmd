...
#Note the cleaning of income variables in AB was done, creating revision1 of raw data. But, we are cleaning income in a stata file. So here we use raw original data.
...
str(check)
#Please keep in mind that without weights, the sample is biased both toward lots of young people and lots who appear here as having preprimary education.  
```
...
#Generate entropy of age in scheme-2 cumulative coding, ten bins.
